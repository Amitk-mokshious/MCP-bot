 ...
 * NOTE: Using global fetch - context.http doesn't exist in trigger contexts
 * Domain must be configured in Devvit.configure() and .devvitrc.json
 */
export async function searchProxyFAQ(
  ...
  try {
    // Use global fetch - domain is configured in Devvit.configure() and .devvitrc.json
